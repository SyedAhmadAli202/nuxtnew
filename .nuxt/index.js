...
import nuxt_plugin_plugin_24384cf3 from 'nuxt_plugin_plugin_24384cf3' // Source: .\\vuetify\\plugin.js (mode: 'all')
import nuxt_plugin_pluginutils_5dc686aa from 'nuxt_plugin_pluginutils_5dc686aa' // Source: .\\nuxt-i18n\\plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_877fdd16 from 'nuxt_plugin_pluginrouting_877fdd16' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_3326561a from 'nuxt_plugin_pluginmain_3326561a' // Source: .\\nuxt-i18n\\plugin.main.js (mode: 'all')
import nuxt_plugin_nuxtmq_357af84c from 'nuxt_plugin_nuxtmq_357af84c' // Source: .\\nuxt-mq.js (mode: 'all')
import nuxt_plugin_nuxttypeform_6ab761f2 from 'nuxt_plugin_nuxttypeform_6ab761f2' // Source: .\\nuxt-typeform.js (mode: 'all')
import nuxt_plugin_fontawesome_75f68886 from 'nuxt_plugin_fontawesome_75f68886' // Source: .\\fontawesome.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_24384cf3 === 'function') {
    await nuxt_plugin_plugin_24384cf3(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_5dc686aa === 'function') {
    await nuxt_plugin_pluginutils_5dc686aa(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_877fdd16 === 'function') {
    await nuxt_plugin_pluginrouting_877fdd16(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_3326561a === 'function') {
    await nuxt_plugin_pluginmain_3326561a(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxtmq_357af84c === 'function') {
    await nuxt_plugin_nuxtmq_357af84c(app.context, inject)
  }

  if (typeof nuxt_plugin_nuxttypeform_6ab761f2 === 'function') {
    await nuxt_plugin_nuxttypeform_6ab761f2(app.context, inject)
  }

  if (typeof nuxt_plugin_fontawesome_75f68886 === 'function') {
    await nuxt_plugin_fontawesome_75f68886(app.context, inject)
  }
